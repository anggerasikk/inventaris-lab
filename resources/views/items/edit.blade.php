...
@section('content')
<div class="card">
    <div class="card-header" style="background-color: #F6FF99;">
        ...
        <form action="{{ route('items.update', $item->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location', $item->location) }}" required>
                    @error('location')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('items.show', $item->id) }}" class="btn btn-info">Lihat Detail</a>
            </div>
        </form>
    </div>
</div>
